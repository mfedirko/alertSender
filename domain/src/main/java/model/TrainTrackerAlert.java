...
public class TrainTrackerAlert implements Alert {

    private int id;
    private String headline;
    private String shortDesc;

    public TrainTrackerAlert() {
    }

    @Override
    public String toString() {
        return "TrainTrackerAlert{" +
                "id=" + id +
                ", headline='" + headline + '\'' +
                ", shortDesc='" + shortDesc + '\'' +
                ", fullDesc='" + fullDesc + '\'' +
    ...
    public TrainTrackerAlert(int id, String headline, String shortDesc, String fullDesc, AlertSeverity severity, Date eventStart, Date eventEnd, boolean TBD, boolean isMajorAlert, String alertURL, String impactedServiceIds) {
        this.id = id;
